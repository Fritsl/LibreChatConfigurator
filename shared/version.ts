...
export const VERSION_INFO = {
  ...
  changelog: "Web Search Import: Added jinaRerankerUrl field support, fixed merge import UI sync issue with useEffect, added structure validation to prevent misplaced nested fields."
} as const;
